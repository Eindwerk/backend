    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('stadium.name')->label('Stadion')->searchable(),
                Tables\Columns\TextColumn::make('homeTeam.name')->label('Thuisploeg')->searchable(),
                Tables\Columns\TextColumn::make('awayTeam.name')->label('Uitploeg')->searchable(),
                Tables\Columns\TextColumn::make('match_date')->label('Datum')->dateTime()->sortable(),
                Tables\Columns\TextColumn::make('home_score')->label('Thuis')->sortable(),
                Tables\Columns\TextColumn::make('away_score')->label('Uit')->sortable(),
            ])
            ->actions([
